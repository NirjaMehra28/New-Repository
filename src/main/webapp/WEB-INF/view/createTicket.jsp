      ...
      <div class="ctrlqCenteredContent">
        <div class="ctrlqFormCard">
          ...
          <div class="ctrlqFormContent">
            ...
            <form action="raiseTicket" method="POST" modelAttribute="ticket_details">  
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="created_by" name="created_by" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
                  <label for="created_by">Your Id</label>
                  <div id="e1"></div>
                </div>
              </div>
			...
			<div class="row">
                <div class="input-field col s12">
                  <input id="created_on" name="created_on" type="date" required>
                  <label for="created_on">Ticket Raised On</label>
                  <div id="e1"></div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="input-field col s12">
                   <select id="severity" name="severity" class="validate" data-error="#e3" required>    
               ...
               <div class="row">
                <div class="input-field col s12">
                   <select id="issue_cat" name="issue_cat" class="validate" data-error="#e3" required>    
               ...
               <div class="row">
                <div class="input-field col s12">
                   <select id="issue_sub_cat" name="issue_sub_cat" class="validate" data-error="#e3" required>    
                      <option value="1">issue_sub_cat </option> 
                      <option value="2">issue_sub_cat</option>
                      <option value="3">issue_sub_cat</option>
                  </select> 
                  
                  <label for="issue_sub_cat">Issue Sub Category</label>
               ...
               <div class="row">
                <div class="input-field col s12">
                  <input id="comments" name="comments" type="text" class="validate" data-error="#e5">
              ...
              <div class="row">
                <div class="input-field col s12">
                   <select id="ticket_status" name="ticket_status" class="validate" data-error="#e3" required>    
      ...
      $(document).ready(function() {
        ...
        $("form").validate({
          submitHandler: function(form) {
            alert("Thanks for raising Ticket.We will look into the issue");
            return true;
